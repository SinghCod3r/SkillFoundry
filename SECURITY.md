...
- **Malicious evaluation task:** ProcessRunner escape attempts during subprocess execution.
...
- **No Auto-Execution:** Generated commands are **never** executed automatically. They require explicit confirmation or run within subprocess execution.
...
- **ProcessRunner Evaluation:** V0.1 does not execute arbitrary repository code or generated scripts. Execution is strictly limited to evaluating test runners and framework wrappers on isolated tasks, not the source code being analyzed.
